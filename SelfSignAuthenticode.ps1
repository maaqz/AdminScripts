...
#et Certifcate to Script'
Set-AuthenticodeSignature -FilePath "PATH\TO\AUTHENTICODESIGANTURE" -Certificate $codeCertificate -TimeStampServer "https://timestamp.fabrikam.com/scripts/timstamper.dll"
#heck Certificate
Get-AuthenticodeSignature -FilePath "PATH\TO\AUTHENTICODESIGANTURE"